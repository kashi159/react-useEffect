...
const Login = (props) => {
  ...
  const emailChangeHandler = (event) => {
    ...
    // setFormIsValid(
    //   event.target.value.includes("@") && enteredPassword.trim().length > 6 && enteredCollegeName.trim().length >3
    // );
  };
  ...
  const collegeNameChangeHandler = (event) => {
    ...
    // setFormIsValid(
    //   event.target.value.trim().length > 3 && enteredPassword.trim().length > 6 && enteredEmail.includes("@")
    // );
  };
